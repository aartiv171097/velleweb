  ...
  <div class="row">
    <section class="col-md-12">
      <div class="bg-white text-center" style="margin-top:100px;">
        ...
        <p class="f-14 normal-line-height text-black font-semi-bold" style="margin:50px;">To receive CAMPAIGN,<br>complete your social info</p>
      </div>
    </section>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content box-shadow-none">
          <div class="modal-header no-border">
            <button type="button" class="close" data-dismiss="modal"><img src="img/close-pop.png" /></button>
          </div>
          <div class="modal-body text-center">
            <p class="pop-barcode no-margin"><img src="img/pop-barcaode.jpg" /></p>
